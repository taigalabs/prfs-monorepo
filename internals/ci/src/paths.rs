...
pub struct Paths {
    ...
    pub prfs_program_spartan_js: PathBuf,
    pub prfs_program_spartan_wasm: PathBuf,
    pub prfs_program_spartan_wasm_build: PathBuf,
...
impl Paths {
    pub fn new() -> Paths {
        ...
        let prfs_program_spartan_wasm = curr_dir.join("source/prfs_program_spartan_wasm");
        let prfs_program_spartan_wasm_build =
            curr_dir.join("source/prfs_program_spartan_wasm/build");
        ...
        let prfs_program_spartan_js = curr_dir.join("source/prfs_program_spartan_js");
