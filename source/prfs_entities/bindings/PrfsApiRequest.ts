...
export type PrfsApiRequest =
  ...
  | ({ type: "GetLeastRecentPrfsIndex" } & GetLeastRecentPrfsIndexRequest)
  | ({ type: "GetPrfsIndices" } & GetPrfsIndicesRequest)
  | ({ type: "AddPrfsIndex" } & AddPrfsIndexRequest)
  ...
  | ({ type: "GetPrfsProofInstanceByInstanceId" } & GetPrfsProofInstanceByInstanceIdRequest)
  | ({ type: "GetPrfsProofInstanceByShortId" } & GetPrfsProofInstanceByShortIdRequest)
  | ({ type: "CreatePrfsProofInstance" } & CreatePrfsProofInstanceRequest)
  ...
  | ({ type: "GetPrfsSetBySetId" } & GetPrfsSetBySetIdRequest)
  | ({ type: "GetPrfsSets" } & GetPrfsSetsRequest)
  | ({ type: "GetPrfsSetsBySetType" } & GetPrfsSetsBySetTypeRequest)
  | ({ type: "CreatePrfsSet" } & CreatePrfsSetRequest)
  | ({ type: "CreatePrfsDynamicSetElement" } & CreatePrfsDynamicSetElementRequest)
  | ({ type: "CreateTreeOfPrfsSet" } & CreateTreeOfPrfsSetRequest)
  | ({ type: "ImportPrfsSetElements" } & ImportPrfsSetElementsRequest)
  | ({ type: "GetPrfsSetElements" } & GetPrfsSetElementsRequest)
  | ({ type: "get_prfs_set_element" } & GetPrfsSetElementRequest)
  | ({ type: "GetPrfsTreeNodesByPos" } & GetPrfsTreeNodesByPosRequest)
  | ({ type: "GetPrfsTreeLeafNodesBySetId" } & GetPrfsTreeLeafNodesBySetIdRequest)
  | ({ type: "GetPrfsTreeLeafIndices" } & GetPrfsTreeLeafIndicesRequest)
