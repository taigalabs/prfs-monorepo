...
import type { GetPrfsAtstGroupsByGroupTypeRequest } from "./GetPrfsAtstGroupsByGroupTypeRequest";
...
export type PrfsAtstApiRequest =
  ...
  | ({ type: "get_prfs_atst_groups_by_group_type" } & GetPrfsAtstGroupsByGroupTypeRequest)
