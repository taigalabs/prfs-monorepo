...
use prfs_entities::atst_api_entities::{
    AttestTwitterAccRequest, AttestTwitterAccResponse, FetchAssetRequest, GetTwitterAccAtstRequest,
...
pub async fn fetch_asset(req: Request<Incoming>, state: Arc<ServerState>) -> ApiHandlerResult {
    let req: FetchAssetRequest = parse_req(req).await;
