...
function createEnvs(values: CliArgs) {
  ...
  const envs: Envs = {
    ...
    NEXT_PUBLIC_PRFS_CONSOLE_WEBAPP_ENDPOINT: ep.prfs_console_webapp,
    NEXT_PUBLIC_PRFS_PROOF_WEBAPP_ENDPOINT: ep.prfs_proof_webapp,
    NEXT_PUBLIC_PRFS_ID_WEBAPP_ENDPOINT: ep.prfs_id_webapp,
    NEXT_PUBLIC_PRFS_POLL_WEBAPP_ENDPOINT: ep.prfs_poll_webapp,
    ...
    NEXT_PUBLIC_SHY_WEBAPP_ENDPOINT: ep.shy_webapp,
  };
