...
function createEnvs() {
  ...
  const env_dev: Envs = {
    ...
    NEXT_PUBLIC_WEBAPP_GENERATOR_ENDPOINT: "http://localhost:3020",
  ...
  const env_prod: Envs = {
    NEXT_PUBLIC_IS_TEASER: teaser ? "yes" : "no",
    NEXT_PUBLIC_WEBAPP_CONSOLE_ENDPOINT: "http://prfs.xyz",
    NEXT_PUBLIC_WEBAPP_GENERATOR_ENDPOINT: "http://gen.prfs.xyz",
