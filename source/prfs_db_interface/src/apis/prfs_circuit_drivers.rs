...
(circuit_driver_id, circuit_driver_repository_url, version, author, 'desc', circuit_types, \
driver_properties_meta)
VALUES ($1, $2, $3, $4, $5, $6, $7) returning circuit_driver_id";

    let row = sqlx::query(query)
        .bind(&circuit_driver.circuit_driver_id)
        .bind(&circuit_driver.circuit_driver_repository_url)
