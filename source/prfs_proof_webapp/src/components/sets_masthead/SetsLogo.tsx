...
const SetsLogo: React.FC<AttestationsLogoAreaProps> = ({ handleClickShowLeftBar, label }) => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <a className={styles.logoArea} href={paths.attestations}>
        <ImageLogo width={24} />
