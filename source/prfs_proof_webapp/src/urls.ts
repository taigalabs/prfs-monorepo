...
export const urls = {
  ...
  console__sets: `${envs.NEXT_PUBLIC_PRFS_CONSOLE_WEBAPP_ENDPOINT}/${paths.sets}`,
  console__proof_types: `${envs.NEXT_PUBLIC_PRFS_CONSOLE_WEBAPP_ENDPOINT}/${paths.proof_types}`,
};
