...
function wrapExports(prfsWasm) {
    ...
    return {
        ...
        async makeMerkleProof(leaves, leaf_idx, depth) {
            ...
            const merkleProof = prfsWasm.make_merkle_proof(obj);
