...
export default class SpartanDriver implements CircuitDriver {
    ...
    makeMerkleProof(leaves: string[], leafIdx: BigInt, depth: number): Promise<import("@taigalabs/prfs-circuit-interface/bindings/SpartanMerkleProof").SpartanMerkleProof>;
