...
const PrivacyPage = () => {
  return (
    <DefaultLayout>
        ...
        <div className={styles.bodyContainer}>
          <div className={styles.inner}>
            <Markdown>
              ...
              <p>
                At Prfs, accessible from www.prfs.xyz, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is
                collected and recorded by Prfs and how we use it.
              </p>
              ...
              <p>
                ...
                Prfs. This policy is not applicable to any information collected offline or via
              ...
              <p>
                Prfs follows a standard procedure of using log files. These files log visitors when
              ...
              <p>
                ...
                on Prfs, which are sent directly to users' browser. They automatically receive your
              ...
              <p>
                Note that Prfs has no access to or control over these cookies that are used by
              ...
              <p>
                Prfs's Privacy Policy does not apply to other advertisers or websites. Thus, we are
              ...
              <p>
                Prfs does not knowingly collect any Personal Identifiable Information from children
      ...
      <DefaultFooter>123</DefaultFooter>
    </DefaultLayout>
  );
};
