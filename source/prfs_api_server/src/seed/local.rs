...
pub fn load_circuits() -> HashMap<String, PrfsCircuit> {
    ...
    for circuit in build_list_json.circuits {
        ...
        let circuit_json: PrfsCircuit = read_json_file(&circuit_json_path);
...
pub fn load_circuit_drivers() -> HashMap<String, PrfsCircuitDriver> {
    ...
    let circuit_drivers: Vec<PrfsCircuitDriver> = read_json_file(&json_path);
...
pub fn load_circuit_types() -> HashMap<String, PrfsCircuitType> {
    ...
    let circuit_types: Vec<PrfsCircuitType> = read_json_file(&json_path);
...
pub fn load_prfs_accounts() -> HashMap<String, PrfsAccount> {
    ...
    let prfs_accounts: Vec<PrfsAccount> = read_json_file(&json_path);
...
pub fn load_policy_items() -> HashMap<String, PrfsPolicyItem> {
    ...
    let prfs_policy_items: Vec<PrfsPolicyItem> = read_json_file(&json_path);
...
pub fn load_circuit_input_types() -> HashMap<String, PrfsCircuitInputType> {
    ...
    let circuit_input_types: Vec<PrfsCircuitInputType> = read_json_file(&json_path);
...
pub fn load_proof_types() -> HashMap<String, PrfsProofType> {
    ...
    let proof_types: Vec<PrfsProofType> = read_json_file(&json_path);
...
pub fn load_dynamic_sets() -> HashMap<String, DynamicSetJson> {
    ...
    let dynamic_sets: Vec<DynamicSetJson> = read_json_file(&json_path);
