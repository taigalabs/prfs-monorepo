export default {
  ...
  now_is_the_time_to_write_it_down:
    "Now is the one and only time you can write it down at a safe place. Make sure you do not lose it",
  enter_your_id: "Enter your Id",
  sign_in_with_your_id: "Try signing in with your new identity",
  create_a_strong_password:
    "Create a password with a mix of upper/lower case lettters, numbers, and symbols. Password needs to be 8 characters or long",
